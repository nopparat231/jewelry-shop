...
$query_prdt = "SELECT * FROM tbl_product WHERE t_id=$t_id ORDER BY p_id ASC";
...
<div class="row">
	...
	<div class="span9">
		...
		<div class="well well-small">
			<h3><?php echo $_GET['type_name']; ?> </h3>
			<!-- <div class="row"> -->
				<div class="row-fluid">

					<ul class="thumbnails">
<?php if ($totalRows_prdt <= 0) {
echo "ไม่มีสินค้า";
}
	?>
						<?php if ($totalRows_prdt > 0) {?> <!-- ตรวจสอบถ้ามีสินค้าในดาต้าเบสมากกว่า 0 ชิ้น ให้แสดงสินค้า -->
				...
				} while ($row_prdt = mysql_fetch_assoc($prdt)); ?>
			<?php } mysql_free_result($prdt); ?>
