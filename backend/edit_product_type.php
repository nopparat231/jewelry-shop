...
<body>
  ...
  <div class="container">
      ...
      <div class="col-md-6">
        ...
        <div class="table">
          <form action="edit_product_type.php" method="POST" name="ptype" id="ptype" class="form-horizontal">
           <div class="form-group">
            
            
             <div class="col-sm-3" align="right"> ประเภทสินค้า </div>
             <div class="col-sm-4">
              <input type="text" name="t_name" class="form-control"  value="<?php echo $row_edittype['t_name']; ?>" required>
             </div>
             <br>
