...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2019 at 04:52 PM
...
(13, 'staff', 'staff', 'staff', 'add', '0853333333', '12dd@ff.cc', 'staff', '2019-06-03 09:41:15');
...
(0000000033, 19, 'สมพร', '9/7', 'bomme5547@gmail.com', '0837818704', 1, '', '', '', '0000-00-00', 0.00, '', '2019-06-03 17:14:22'),
(0000000034, 19, 'สมพร', '9/7', 'bomme5547@gmail.com', '0837818704', 2, '5929272520190603_173347.jpg', 'กสิกรไทย', '543-1534-54634-212', '2019-06-03', 9510.72, '', '2019-06-03 17:29:26');
...
(00000000033, 00000000033, 00000000067, 'ต่างหูทองรูปดอกไม้', 1, 1845.75),
(00000000034, 00000000034, 00000000060, 'แหวน Biker Z1 clear', 1, 1871.59),
(00000000035, 00000000034, 00000000071, 'สร้อย+จี้ไข่มุก', 2, 7602.51);
...
INSERT INTO `tbl_product` (`p_id`, `t_id`, `p_name`, `p_detial`, `p_price`, `p_unit`, `p_img1`, `p_img2`, `p_view`, `p_qty`, `p_ems`, `p_size`, `p_sell`, `promo`, `date_save`) VALUES
...
(00000000071, 18, 'สร้อย+จี้ไข่มุก', '<p>สร้อยเงิน + จี้ไข่มุกสีชมพู +ไข่มุกสีดำ</p>\r\n\r\n<p>ประดับ CZ 3A&nbsp;</p>\r\n', 2990.00, 'ชิ้น', 'img1103925084920181018_231706.jpg', '', 0, 3, 45, 'free', '', '3200', '2018-10-18 16:17:06'),
...
--
ALTER TABLE `tbl_order`
  MODIFY `order_id` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `tbl_order_detail`
--
ALTER TABLE `tbl_order_detail`
  MODIFY `d_id` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
